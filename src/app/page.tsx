...
export default function Home() {
  return (
    ...
    <MaxWidthScreen>
      ...
      <h1 className="text-4xl font-bold track-tight text-gray-900 sm:text-6xl">Your marketplace for high-quality{' '}
      <span className="text-green-500">digital assets</span>
      .
      </h1>
      <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to BlueHippo. Every asset on our platform is verfified by our team to ensure our highest quality standards.</p>
    ...
    <section className="border-t border-gray-200 bg-gray-50">
      <MaxWidthScreen className="py-20">
